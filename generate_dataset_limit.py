...
def filter(index, confidence, index_list, confidence_list):
    ...
    if index == 1:
        if ((confidence>=0.26 and confidence<=0.70) or (confidence>=0.70 and confidence<=0.865)) and (num[2]>=1,num[3]):
            return index
    if index == 2:
        if ((confidence>=0.26 and confidence<=0.51) or (confidence>=0.51 and confidence<=0.68) or (confidence>=0.7 and confidence<=0.87) or (confidence>=0.87 and confidence<=0.97)) and (num[1]>=1 or num[4]>=1 or num[0]>=1):
            return index
    if index == 3:
        if ((confidence>=0.36 and confidence<=0.76) or (confidence>=0.82 and confidence<=0.90)) and (num[1]>=1 or num[2]>=1) or num[4]>=1:
            return index
    if index == 4:
...
def hands_to_center(index, righthand, lefthand):
    if index == 5:
        ...
        if (((lefthand[0]>0.5 and lefthand[1]<0.5 and righthand[0]<0.5 and righthand[1]>0.5) or (lefthand[0]<0.5 and lefthand[1]>0.5 and righthand[0]>0.5 and righthand[1]<0.5)) and ((lefthand[1]-righthand[1]>0.3) or (righthand[1]-lefthand[1]>0.3))):
        ...
        if ((lefthand[0]>0.5 and lefthand[1]>0.5 and righthand[0]<0.5 and righthand[1]<0.5) or (lefthand[0]>0.5 and lefthand[1]>0.5 and righthand[0]<0.5 and righthand[1]<0.5)):
