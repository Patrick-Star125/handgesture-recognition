...
if __name__ == "__main__":
    ...
    #   获取classes和anchor
    # ----------------------------------------------------#
    class_names = get_classes(classes_path) # list(20)
    anchors = get_anchors(anchors_path)  # array(1,3,2)
    ...
    # ------------------------------------------------------#
    '''
    此处创建了这样一个模型对象，属性有backbone，一个conv，一个upsample，两个head
    '''
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    annotation_path = 'D:\Dataset\coco\\val.txt'
    # ----------------------------------------------------------------------#
